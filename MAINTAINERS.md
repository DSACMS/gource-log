...
gource-log uses [Semantic Versioning](https://semver.org/). Each release is associated with a [`git tag`](github.com/DSACMS/gource-log/tags) of the form `X.Y.Z`.
...
[proj-releases-new]: https://github.com/DSACMS/gource-log/releases/new
